...
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="login">
            <form id="kayit_form" class="custom-form" method="Post" action="javascript:void(0)">
                <div class="input-group mb-3">
                    ...
                    <input type="email" class="form-control" name="eposta" id="eposta" aria-label="E-Posta"
                        placeholder="E-Posta">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text"><svg width="24" height="24" fill="none"
                    ...
                    <input type="password" name="sifre" id="sifre" class="form-control password-input"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password" name="sifre2" id="sifre2" class="form-control password-input"
                ...
                <div class="form-group">
                    <button type="submit" class="btn submit-btn">Kayıt Ol</button>
                </div>
            </form>
    ...
    $("#kayit_form").submit(function() {
        ...
        if (eposta != "" && sifre != "" && sifre2 != "") {
            if (sifre == sifre2) {
                Post_Gonder("kayit_form", "&kayitol");
            } else {
